...
<ul>
  ...
  <li><code>getTimeDifference(date)</code> Get the difference display for a date<ul><li><b>date</b>: The date object</li><b>returns</b>: a string representing the date difference</li></ul></li>
