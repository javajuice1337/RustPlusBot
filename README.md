...
<ul>
    ...
    <li><a href="https://github.com/javajuice1337/RustPlusBot/blob/main/plugin%20examples/vendingtrackany.md"><b>vendingtrackany</b></a><ul><li>This plugin example demonstrates how to log or track only vending machine item changes in a specific location on the server to the Notifications Discord Channel (or the Plugin Notification channel if set in the bot's config).</li></ul></li>
</ul>
